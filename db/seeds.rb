ActiveRecord::Base.transaction do
  ...
  Enrollment.create(course_id: course2.id, student_id: user2.id)

end

# ShortUrl.create_from_input(user1, "google")
#
#   def self.notrandom
#     return "anastassia"
#   end
#
# def self.create_from_input(user, long_url)
#   short_url = ShortUrl.notrandom
#   ShortUrl.create(user_id: user.id, long_url: long_url, short_url: short_url )
#
# end
