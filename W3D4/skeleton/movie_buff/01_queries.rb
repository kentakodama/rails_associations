...
def harrison_ford
  ...
  Movie
    .select(:id, :title)#joins can only use associations
    .joins(:actors) #this refers to the association between Movie + Actors
    .where(actors: {name: 'Harrison Ford'}) #this actors: refers to the table actors
